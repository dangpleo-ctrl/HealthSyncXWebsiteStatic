        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="max-w-3xl mx-auto">
                ...
                <p class="text-lg md:text-xl text-muted-foreground dark:text-gray-300">
                    Mở rộng phạm vi hoạt động tại Việt Nam và khu vực Châu Á – Thái Bình Dương bằng hợp tác chiến lược.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-muted-foreground dark:text-gray-300 max-w-3xl mx-auto">
                Chúng tôi kết hợp kinh nghiệm quốc tế, am hiểu thị trường địa phương và thành tích đã được chứng minh trong lĩnh vực tích hợp công nghệ y tế trên toàn khu vực Châu Á – Thái Bình Dương. Các mối quan hệ hợp tác đều dựa trên tầm nhìn chung, sự tin cậy và cam kết mang lại giá trị thực tế.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-0">
            <div class="bg-slate-100 dark:bg-gray-900 border border-slate-300 dark:border-gray-700 rounded-lg p-6 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/20 transition-shadow">
                ...
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2 text-center">
                    Hiểu biết sâu về thị trường địa phương
                </h3>
                <p class="text-sm text-muted-foreground dark:text-gray-300 text-center">
                    Thấu hiểu thị trường y tế Việt Nam và khu vực APAC, nắm rõ quy định, nhu cầu và xu hướng của người dùng.
                </p>
            </div>
            ...
            <div class="bg-slate-100 dark:bg-gray-900 border border-slate-300 dark:border-gray-700 rounded-lg p-6 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/20 transition-shadow">
                ...
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2 text-center">
                    Mạng lưới đối tác vững mạnh
                </h3>
                <p class="text-sm text-muted-foreground dark:text-gray-300 text-center">
                    Sở hữu mối quan hệ chặt chẽ với các nhà cung cấp dịch vụ y tế, trường đại học và đối tác công nghệ hàng đầu.
                </p>
            </div>
            ...
            <div class="bg-slate-100 dark:bg-gray-900 border border-slate-300 dark:border-gray-700 rounded-lg p-6 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/20 transition-shadow">
                ...
                <p class="text-sm text-muted-foreground dark:text-gray-300 text-center">
                    Chuyên môn sâu trong kỹ thuật y sinh, CNTT y tế và các hệ thống tích hợp phức hợp.
                </p>
            </div>
            ...
            <div class="bg-slate-100 dark:bg-gray-900 border border-slate-300 dark:border-gray-700 rounded-lg p-6 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/20 transition-shadow">
                ...
                <p class="text-sm text-muted-foreground dark:text-gray-300 text-center">
                    Giao tiếp trôi chảy bằng cả tiếng Anh và tiếng Việt, giúp kết nối các đối tác quốc tế với đội ngũ địa phương mà không gặp rào cản ngôn ngữ hay văn hóa.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-slate-100 dark:bg-gray-900 border border-slate-300 dark:border-gray-700 rounded-lg p-8 md:p-12 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/20 transition-shadow">
            ...
            <p class="text-lg text-muted-foreground dark:text-gray-300 leading-relaxed text-center">
                HealthSyncX đóng vai trò là cầu nối giữa hệ sinh thái công nghệ y tế tiên tiến của New Zealand và thị trường y tế đang phát triển nhanh tại Việt Nam. Nhờ hoạt động tại cả hai quốc gia, chúng tôi hiểu rõ thế mạnh, nhu cầu và cơ hội của từng thị trường. HealthSyncX hỗ trợ doanh nghiệp New Zealand tiếp cận môi trường pháp lý và văn hóa Việt Nam, đồng thời giúp tổ chức Việt tiếp cận công nghệ và chuẩn mực y tế quốc tế từ New Zealand.
            </p>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-0">
            ...
            <div class="bg-slate-100 dark:bg-gray-900 border border-slate-300 dark:border-gray-700 rounded-lg p-8 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/20 transition-shadow">
                ...
                <p class="text-muted-foreground dark:text-gray-300 mb-6 text-center">
                    Các nhà sản xuất thiết bị y tế, đơn vị cung cấp phần mềm và doanh nghiệp đổi mới công nghệ muốn mở rộng sang thị trường khu vực Châu Á – Thái Bình Dương.
                </p>
                <div class="pt-4 border-t border-border">
                    <p class="text-sm text-muted-foreground dark:text-gray-300 text-center">
                        Hỗ trợ tiếp cận thị trường • Tư vấn pháp lý • Phân phối nội địa • Dịch vụ tích hợp • Hợp tác sáng tạo đổi mới
                    </p>
                </div>
            </div>
            ...
            <div class="bg-slate-100 dark:bg-gray-900 border border-slate-300 dark:border-gray-700 rounded-lg p-8 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/20 transition-shadow">
                ...
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white text-center mb-4">
                    Đối tác đổi mới hệ thống y tế
                </h3>
                <p class="text-muted-foreground dark:text-gray-300 mb-6 text-center">
                    Bệnh viện, phòng khám và tổ chức y tế muốn nâng cấp công nghệ, tích hợp hệ thống hoặc triển khai chương trình chuyển đổi số.
                </p>
                <div class="pt-4 border-t border-border">
                    <p class="text-sm text-muted-foreground dark:text-gray-300 text-center">
                        Đánh giá lựa chọn công nghệ • Tích hợp các hệ thống • Chuyển đổi số • Đào tạo & hỗ trợ • Chia sẻ kinh nghiệm thực tiễn
                    </p>
                </div>
            </div>
            ...
            <div class="bg-slate-100 dark:bg-gray-900 border border-slate-300 dark:border-gray-700 rounded-lg p-8 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/20 transition-shadow">
                ...
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white text-center mb-4">
                    Đối tác nghiên cứu và giáo dục đào tạo
                </h3>
                <p class="text-muted-foreground dark:text-gray-300 mb-6 text-center">
                    Các trường đại học, trung tâm nghiên cứu và cơ sở giáo dục mong muốn hợp tác nghiên cứu, chia sẻ kiến thức và phát triển năng lực.
                </p>
                <div class="pt-4 border-t border-border">
                    <p class="text-sm text-muted-foreground dark:text-gray-300 text-center">
                        Hợp tác nghiên cứu • Trao đổi kiến thức • Chương trình đào tạo sinh viên • Hợp tác sáng tạo đổi mới
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-foreground dark:text-white mb-4">
                Tìm hiểu chi tiết về hợp tác
            </h2>
            <p class="text-lg text-muted-foreground dark:text-gray-300">
                Nếu bạn quan tâm đến việc hợp tác, xin để lại thông tin bên dưới. Chúng tôi sẽ liên hệ để trao đổi chi tiết.
            </p>
        </div>
        ...
        <div class="bg-slate-100 dark:bg-gray-900 border border-slate-300 dark:border-gray-700 rounded-lg p-8 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/20 transition-shadow">
            <form id="collaboration-form" data-lang="vi" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label for="organization" class="text-sm font-medium text-foreground">Công ty/Tổ chức *</label>
                        <input
                            id="organization"
                            name="organization"
                            type="text"
                ...
                <div class="space-y-2">
                    <label for="website" class="text-sm font-medium text-foreground">Website (nếu có)</label>
                    <input
                        id="website"
                        name="website"
                        type="url"
                ...
                <div class="space-y-2">
                    <label for="partnerType" class="text-sm font-medium text-foreground">Hình thức hợp tác *</label>
                    <select
                        id="partnerType"
                        name="partnerType"
                        required
                    ...
                    >
                        ...
                        <option value="healthcare">Đối tác đổi mới hệ thống y tế</option>
                        <option value="research">Đối tác nghiên cứu và giáo dục đào tạo</option>
                        <option value="other">Đối tác khác</option>
                    </select>
                </div>
                
                <div class="space-y-2">
                    <label for="description" class="text-sm font-medium text-foreground">Hãy chia sẻ với chúng tôi về tổ chức và mục tiêu hợp tác của bạn *</label>
                    <textarea
                        id="description"
                        name="description"
                        required

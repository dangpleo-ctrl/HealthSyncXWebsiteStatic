    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <div class="relative">
                    <div class="aspect-[4/3] rounded-lg overflow-hidden shadow-lg">
                        <img src="/assets/images/service-technology-guidance.jpg" alt="Tư vấn kinh doanh và kế hoạch chiến lược" class="w-full h-full object-cover object-center">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-slate-100 dark:bg-gray-900 border border-slate-300 dark:border-gray-700 rounded-lg p-8 md:p-12 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/20 transition-shadow">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <div class="relative">
                    <div class="aspect-[4/3] rounded-lg overflow-hidden shadow-lg">
                        <img src="/assets/images/service-holistic-integration.jpg" alt="Công nghệ mạng và tích hợp hệ thống" class="w-full h-full object-cover object-center">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-slate-100 dark:bg-gray-900 border border-slate-300 dark:border-gray-700 rounded-lg p-8 md:p-12 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/20 transition-shadow">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <div class="relative">
                    <div class="aspect-[4/3] rounded-lg overflow-hidden shadow-lg">
                        <img src="/assets/images/service-training.jpg" alt="Đào tạo chuyên nghiệp và giáo dục công nghệ" class="w-full h-full object-cover object-center">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-slate-100 dark:bg-gray-900 border border-slate-300 dark:border-gray-700 rounded-lg p-8 md:p-12 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/20 transition-shadow">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <div class="relative">
                    <div class="aspect-[4/3] rounded-lg overflow-hidden shadow-lg">
                        <img src="/assets/images/service-workflow-optimization.jpg" alt="Tối ưu hóa quy trình và cải tiến quy trình" class="w-full h-full object-cover object-center">
                    </div>
                </div>
            </div>
        </div>

...
<section class="py-16 bg-background">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-6xl mx-auto">
            <div class="bg-slate-100 dark:bg-gray-900 border border-slate-300 dark:border-gray-700 rounded-lg p-8 md:p-12 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/20 transition-shadow">
                <div class="grid grid-cols-1 md:grid-cols-[1.15fr_1fr] gap-8 md:gap-12">
                    ...
                    <div class="flex flex-col items-center text-center space-y-6">
                        ...
                        <div class="w-full space-y-3">
                            <div class="flex items-start gap-3 text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="font-semibold text-gray-900 dark:text-white text-sm leading-tight mb-1">MSc Biomedical Engineering</p>
                            ...
                            <div class="flex items-start gap-3 text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="font-semibold text-gray-900 dark:text-white text-sm leading-tight mb-1">MEng Telecommunication Engineering</p>
                            ...
                            <div class="flex items-start gap-3 text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="font-semibold text-gray-900 dark:text-white text-sm leading-tight mb-1">BSc Electrical Engineering</p>
                            ...
                            <div class="flex items-start gap-3 text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="font-semibold text-gray-900 dark:text-white text-sm leading-tight mb-1">Nationally Certified Trainer</p>
                            ...
                            <div class="flex items-start gap-3 text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="font-semibold text-gray-900 dark:text-white text-sm leading-tight mb-1">Strategic Leadership and Management</p>
                            ...
                            <div class="flex items-start gap-3 text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="font-semibold text-gray-900 dark:text-white text-sm leading-tight mb-1">Digital Health Specialization</p>
                            ...
                            <div class="flex items-start gap-3 text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="font-semibold text-gray-900 dark:text-white text-sm leading-tight mb-1">AI in Healthcare Specialization</p>
                        ...
                        <a 
                            ...
                            class="inline-flex items-center justify-center px-4 py-2 bg-slate-600 text-white rounded-md text-sm font-medium hover:bg-slate-700 transition-colors no-underline"
                        >

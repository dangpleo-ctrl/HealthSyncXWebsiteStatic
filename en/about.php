    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div class="bg-orange-50 dark:bg-gray-900 border border-orange-200 dark:border-gray-700 rounded-lg p-8 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/10 transition-shadow">
                <h2 class="text-3xl md:text-4xl font-bold text-foreground dark:text-white mb-6 text-center">
                    Our Vision
                </h2>
        ...
        <!-- Story -->
        <div class="bg-orange-50 dark:bg-gray-900 border border-orange-200 dark:border-gray-700 rounded-lg p-8 md:p-12 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/10 transition-shadow">
            <h2 class="text-3xl md:text-4xl font-bold text-foreground dark:text-white mb-6 text-center">
                About HealthSyncX
            </h2>
                        ...
                        <div class="w-full space-y-3">
                            <div class="flex items-start gap-3 text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-muted-foreground dark:text-gray-300 leading-tight">University of Oxford, England</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3 text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-muted-foreground dark:text-gray-300 leading-tight">University of Melbourne, Australia</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3 text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-muted-foreground dark:text-gray-300 leading-tight">University of California - Los Angeles, USA</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3 text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-muted-foreground dark:text-gray-300 leading-tight">Australian Skills Quality Authority (ASQA)</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3 text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-muted-foreground dark:text-gray-300 leading-tight">University of Illinois, USA</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3 text-left">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-muted-foreground dark:text-gray-300 leading-tight">Imperial College London, England</p>
                                </div>
                            </div>

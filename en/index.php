        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-orange-50 dark:bg-gray-900 border border-orange-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/10 transition-shadow">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h3 class="text-base font-semibold text-foreground dark:text-white mb-1">Disconnected Systems</h3>
            ...
            <div class="bg-orange-50 dark:bg-gray-900 border border-orange-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/10 transition-shadow">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h3 class="text-base font-semibold text-foreground dark:text-white mb-1">Unclear ROI</h3>
            ...
            <div class="bg-orange-50 dark:bg-gray-900 border border-orange-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/10 transition-shadow">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h3 class="text-base font-semibold text-foreground dark:text-white mb-1">Workflow Friction</h3>
            ...
            <div class="bg-orange-50 dark:bg-gray-900 border border-orange-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/10 transition-shadow">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h3 class="text-base font-semibold text-foreground dark:text-white mb-1">Security & Compliance Risks</h3>
            ...
            <div class="bg-orange-50 dark:bg-gray-900 border border-orange-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/10 transition-shadow">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h3 class="text-base font-semibold text-foreground dark:text-white mb-1">Resistance to Change</h3>
            ...
            <div class="bg-orange-50 dark:bg-gray-900 border border-orange-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/10 transition-shadow">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h3 class="text-base font-semibold text-foreground dark:text-white mb-1">Vendor Lock-In</h3>
...
<section class="pt-24 pb-12 bg-background">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-orange-50 dark:bg-gray-900 border border-orange-200 dark:border-gray-700 rounded-lg p-6 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-white/10 transition-shadow md:col-span-2 md:col-start-2 lg:col-span-2 lg:col-start-2">
                <div class="flex items-center justify-center mb-4 mx-auto">

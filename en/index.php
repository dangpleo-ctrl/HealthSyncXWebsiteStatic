...
<section class="pt-24 pb-12 bg-background">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-gradient-to-br from-primary/10 to-primary/20 border border-primary/20 rounded-lg p-6 hover:shadow-lg transition-shadow md:col-span-2 md:col-start-2 lg:col-span-2 lg:col-start-2">
